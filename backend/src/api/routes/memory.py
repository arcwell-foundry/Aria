...
# Re-export for backward compatibility — canonical location is
# src.services.memory_query_service
from src.services.memory_query_service import MemoryQueryService  # noqa: F401
