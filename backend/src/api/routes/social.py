...
async def list_drafts(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to list drafts. Please try again."
        ) from e
...
async def approve_draft(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to approve draft. Please try again."
        ) from e
...
async def reject_draft(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to reject draft. Please try again."
        ) from e
...
async def schedule_draft(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to schedule draft. Please try again."
        ) from e
...
async def list_published(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to list published posts. Please try again."
        ) from e
...
async def approve_reply(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to approve reply. Please try again."
        ) from e
...
async def get_social_stats(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Failed to fetch stats. Please try again."
        ) from e
