  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-md mx-4 bg-slate-800 border border-slate-700 rounded-2xl shadow-2xl">
        <div className="p-6">
          {/* Icon */}
          <div className="mx-auto w-12 h-12 flex items-center justify-center rounded-full bg-critical/20 mb-4">
            <svg
              className="w-6 h-6 text-critical"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="mt-6 flex gap-3">
            ...
            <button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-critical hover:brightness-110 rounded-lg transition-colors disabled:opacity-50"
            >
              {isLoading ? (
                <>
